...
const [
  ...
  importFromRepo("backend/services/prowlarrClient.ts"),
  importFromRepo("backend/services/nzbgetClient.ts"),
  importFromRepo("backend/services/downloadSourceService.ts"),
  importFromRepo("backend/services/weeklyFlowUsenetMatcher.ts"),
