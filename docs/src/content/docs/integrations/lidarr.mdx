...
On mixed Windows/Docker setups, **Test library access** shows the exact path Lidarr reports. If that folder is mounted at a different path inside Aurral, add a mapping under **Settings → Downloads → Advanced remote path mappings**.
