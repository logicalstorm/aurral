...
5. Optionally connect Navidrome, Plex, Last.fm, slskd, Prowlarr, NZBGet, Ticketmaster, and metadata services.
...
- **Settings → Download Clients** — slskd and/or Prowlarr + NZBGet for flow and playlist downloads.
