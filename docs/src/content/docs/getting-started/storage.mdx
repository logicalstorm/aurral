...
1. In Aurral **Settings → Playlists**, set your download folder to a path inside that mount, for example `/music/Aurral`.
...
3. If auto-detect does not work, open **Settings → Playlists → Path mappings**, click **Detect from Lidarr**, or add a manual **Remote path** / **Local path** pair, then save.
