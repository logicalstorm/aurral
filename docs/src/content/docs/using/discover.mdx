...
Each user sets their own Last.fm or ListenBrainz username in **Profile**. This lets a shared Aurral instance serve different people without mixing every preference together.
