...
Scheduled flows, discover playlists, imported static playlists, in-app playback, and download status. Flows regenerate on a schedule; static playlists keep fixed tracklists.

### History

![Aurral history timeline](../../../assets/screenshots/history.webp)

One timeline for Lidarr requests, download client activity (slskd and NZBGet), and Aurral playlist jobs.
...
| Tab | What it covers |
| --- | --- |
| **Library** | Lidarr connection, profiles, tags, library access check |
| **Downloads** | Prowlarr, NZBGet, slskd, downloads folder, path mappings, cover art |
